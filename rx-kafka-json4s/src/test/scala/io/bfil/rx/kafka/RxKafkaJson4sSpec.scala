...
import io.bfil.kafka.specs2.{DefaultKafkaPorts, EmbeddedKafkaContext}
import io.bfil.rx.kafka.consumer.KafkaConsumer
import io.bfil.rx.kafka.messaging.JsonTopic
import io.bfil.rx.kafka.producer.KafkaProducer
import io.bfil.rx.kafka.serialization.JsonSupport
import io.bfil.rx.kafka.testkit.KafkaSpec
...
class RxKafkaJson4sSpec extends KafkaSpec with JsonSupport {
  ...
  trait WithEmbeddedKafkaTopics extends EmbeddedKafkaContext with DefaultKafkaPorts {
